...
export const kit = {
  ...
  'kit.empty.noAddress': {
    ...
    hi: 'आपके फ़ीडबैक पेज का वेब पता अभी नहीं बना है, इसलिए अभी प्रिंट करने के लिए कोई कार्ड नहीं है। हेडवे इसे तैयार कर रहा है।',
    mr: 'तुमच्या फीडबॅक पेजचा वेब पत्ता अजून तयार नाही, त्यामुळे आत्ता प्रिंट करण्यासाठी कार्ड नाही. हेडवे ते तयार करत आहे.',
  },
  ...
  'kit.form.reviewLink.hint': {
    ...
    hi: 'यह लिंक आप ख़ुद पेस्ट करते हैं। हेडवे इसे कभी ख़ुद नहीं ढूँढता।',
    mr: 'ही लिंक तुम्ही स्वतः पेस्ट करता. हेडवे ती कधीच स्वतः शोधत नाही.',
  },
  'kit.form.saveLink': {
    en: 'Save link',
    hi: 'लिंक सेव करें',
  ...
  'kit.form.defaults': {
    ...
    hi: 'किसी फ़ील्ड को ख़ाली छोड़ दें तो {type} की सामान्य लिखावट लगेगी। हेडवे कोई लाइन तभी बदलता है जब आप ख़ुद कुछ लिखते हैं।',
    mr: 'एखादं फील्ड रिकामं ठेवलं तर {type} चा नेहमीचा मजकूर वापरला जातो. तुम्ही स्वतः काही लिहिलं तरच हेडवे ती ओळ बदलतो.',
  },
