...
export default async function FeedbackQrPage({
  ...
  const headline = !addressReady
    ? 'Headway does not know what address a customer would open, so it has not made a QR.'
    : view.archived
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
        {/* ---- The QR ---- */}
        <Card>
          <CardHeader title="The QR" description="Generated by Headway. Same code on screen, on the card and in the download." />
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardBody className="space-y-4">
              {view.publicReviewUrl ? (
                <Notice tone="good">
                  Customers are offered “{view.publicReviewLabel}” after sending. Headway never
          ...
          <Card>
            ...
            <CardBody className="space-y-3">
              ...
              <InlineHint>
                ...
                opens Headway&rsquo;s own feedback page, where a customer can say anything privately;
          ...
          <Card>
            <CardHeader
              ...
              description="The QR points at the computer Headway runs on. Customers' phones have to be able to reach it."
            />
            <CardBody className="space-y-4">
              {view.baseUrlError ? (
                <Notice tone="bad" title="Headway cannot work out the address">
                  {view.baseUrlError}
                </Notice>
              ) : null}
              {view.baseUrlSource === 'ENV' ? (
                <Notice tone="neutral" title="Set outside Headway">
                  This installation&rsquo;s address is fixed at{' '}
                  <span className="break-all">{view.baseUrl}</span>, set once when Headway was
                  installed. It does not change when Headway restarts, which is what keeps printed
